...
namespace pl {
    ...
    public:
        ...
        [[nodiscard]] const std::vector<std::unique_ptr<ptrn::Pattern>> &getAllPatterns(u64 section = 0x00) const;
    ...
    private:
        ...
        std::map<u64, std::vector<std::unique_ptr<ptrn::Pattern>>> m_patterns;
